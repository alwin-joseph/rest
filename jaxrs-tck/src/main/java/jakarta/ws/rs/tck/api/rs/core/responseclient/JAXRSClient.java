...
public class JAXRSClient extends JAXRSCommonClient {
  ...
  //  */
  // public void getReasonPhraseTest()   {
  //   VerificationResult result = new VerificationResult();
  //   String tmp = null;
  ...
  //  * Family is returned
  //  */
  // public void statusFamilyValueOfTest()   {
  ...
  //     assertFault(match != -1, "Unknown Response Status Family"+ families[i]);
  //   }
  // }
  ...
  //  * Family is returned
  //  */
  // public void statusFamilyValuesTest()   {
  //   Response.Status.Family[] families = Response.Status.Family.values();
  //   assertTrue(families.length == status_family_list.length,
  //       "Response.Status.Family.values() are unexpected");
  //   Arrays.sort(status_family_list);
  ...
  //     assertFault(match != -1, "Unknown Resposne Status Family"+ families[i]);
  //   }
  // }
  ...
  //  * required.
  //  */
  // public void acceptedStringTest()   {
  //   VerificationResult result;
  ...
  //  * required.
  //  */
  // public void acceptedGenericEntityTest()   {
  //   VerificationResult result;
  //   String entity = "ENtiTy";
  ...
  //  */
  // public void bufferEntityIgnoreNoBackingStreamTest()   {
  ...
  //  * been #close() closed.
  //  */
  // public void bufferEntityThrowsIllegalStateExceptionTest()   {
  //   Response response = Response.ok().build();
  //   response.close();
  //   try {
  ...
  //  */
  // public void getAllowedMethodsTest()   {
  ...
  //       assertFault(entry.getValue().equals(cookie1), cookie1.toString()+
  //           "not match"+ entry.getValue());
  //     else if (entry.getKey().equals("c2"))
  //       assertFault(entry.getValue().equals(cookie2), cookie2.toString()+
  //           "not match"+ entry.getValue());
  //     else
  //       assertFault(false, "Got unknown cookie"+ entry.getKey());
  ...
  //  */
  // public void getCookiesIsImmutableTest()   {
  //   NewCookie cookie1 = new NewCookie("c1", "v1");
  //   NewCookie cookie2 = new NewCookie("c2", "v2");
  ...
  //  */
  // public void getDateNotPresentTest()   {
  //   Response response = Response.ok().build();
  //   Date responseDate = response.getDate();
  ...
  //  */
  // public void getEntityThrowsIllegalStateExceptionTest()   {
  ...
  //   assertTrue(tag.equals(responseTag), "response#getEntityTag()"+ responseTag.toString()+
  //       "is unequal to expected EntityTag"+ tag.toString());
  //   logMsg("#getEntityTag is", responseTag.toString(), "as expected");
  // }
  ...
  //  * @test_Strategy: Get null if not present.
  //  */
  // public void getEntityTagNotPresentTest()   {
  //   Response response = Response.ok().build();
  //   EntityTag responseTag = response.getEntityTag();
  //   assertTrue(responseTag == null,
  //       "response#getEntityTag() should be null, was"+ responseTag.toString());
  ...
  //  */
  // public void getHeadersIsMutableTest()   {
  ...
  //  */
  // public void getHeaderStringUsingHeaderDelegateTest()   {
  ...
  //  * or using its toString
  //  */
  // public void getHeaderStringUsingToStringTest()   {
  ...
  //       Locale.CANADA_FRENCH.toString()+ "does NOT match response#getLocale()"+ locale.toString());
  ...
  //  * @test_Strategy: Get null if not present.
  //  */
  // public void getLanguageNotPresentTest()   {
  //   Response response = Response.ok().build();
  //   Locale locale = response.getLanguage();
  ...
  //   assertTrue(date.equals(responseDate), "Last Modified date"+ date.toString()+
  //       "does NOT match response#getLastModified()"+ responseDate.toString());
  ...
  //  * @test_Strategy: Get null if not present.
  //  */
  // public void getLastModifiedNotPresentTest()   {
  //   Response response = Response.ok().build();
  //   Date responseDate = response.getLastModified();
  //   assertTrue(responseDate == null,
  //       "response#getLastModified() should be null, was"+ responseDate.toString());
  ...
  //       "does NOT match response#getLength()"+ len.toString());
  ...
  //  */
  // public void getLengthNotPresentTest()   {
  //   Response response = Response.ok().build();
  //   int len = response.getLength();
  ...
  //       "#getLink() returned unexpected Link"+ responseLink.toString());
  ...
  //  * relation.
  //  */
  // public void getLinkBuilderForTheRelationTest()   {
  ...
  //  * @test_Strategy: returns null if not present.
  //  */
  // public void getLinkBuilderForTheNotPresentRelationTest()   {
  //   Response response = Response.ok().build();
  //   Builder builder = response.getLinkBuilder("anyrelation");
  //   assertTrue(builder == null,
  //       "#getLinkBuilder('relation') returned unexpected builder"+ builder.toString());
  ...
  //  */
  // public void getLinksIsNotNullTest()   {
  //   Response response = Response.ok().build();
  //   Set<Link> responseLinks = response.getLinks();
  ...
  //       responseLocation, "differs from expected"+ location.toString());
  ...
  //  */
  // public void getLocationNotPresentTest()   {
  //   Response response = Response.ok().build();
  //   URI responseLocation = response.getLocation();
  //   assertTrue(responseLocation == null, "#getLocation()"+ responseLocation.toString()+
  //       "should be null");
  ...
  //       "#getMediaType()"+ responseMedia.toString()+ "differs from expected",
  //       MediaType.APPLICATION_ATOM_XML.toString());
  ...
  //  */
  // public void getMediaTypeNoMediaTypeTest()   {
  //   Response response = Response.ok().build();
  //   MediaType responseMedia = response.getMediaType();
  //   assertTrue(responseMedia == null, "#getMediaType()"+ responseMedia.toString()+
  //       "should be null");
  ...
  //         "#getStatusInfo returned unexpected value"+ info.toString());
  //   }
  ...
  //  */
  // public void getStringHeadersUsingToStringTest()   {
  //   RuntimeDelegate original = RuntimeDelegate.getInstance();
  //   RuntimeDelegate.setInstance(new StringBeanRuntimeDelegate(original));
  //   try {
  //     StringBuilder builder = new StringBuilder("s1");
  ...
  //     assertContainsIgnoreCase(header, builder.toString(), "Header"+ builder.toString()+
  //         "has unexpected value"+ header.toString());

  //     header = headers.getFirst(buffer.toString());
  //     assertContainsIgnoreCase(header, buffer.toString(), "Header"+ builder.toString()+
  //         "has unexpected value"+ header.toString());
  ...
  //  */
  // public void hasEntityWhenEntityTest()   {
  //   Response response = Response.ok("entity").build();
  ...
  //  * @test_Strategy: Check if there is an entity available in the response.
  //  */
  // public void hasEntityWhenNoEntityTest()   {
  //   Response response = Response.ok().build();
  ...
  //  */
  // public void hasEntityThrowsIllegalStateExceptionTest()   {
  //   Response response = Response.ok().build();
  //   response.close();
  //   try {
  //     response.hasEntity();
  ...
  //  * @test_Strategy: Check if link for relation exists.
  //  */
  // public void hasLinkWhenNoLinkTest()   {
  //   Response response = Response.ok().build();
  ...
  protected static void assertFault(VerificationResult result)   {
